...
class CurrentOrdersTabListView extends StatefulWidget {
  const CurrentOrdersTabListView({
    super.key,
  });

  @override
  State<CurrentOrdersTabListView> createState() =>
      _CurrentOrdersTabListViewState();
}

class _CurrentOrdersTabListViewState extends State<CurrentOrdersTabListView> {
  @override
  void initState() {
    AppCubit.get(context).showProviderOrders(status: 'new');
    super.initState();
  }
