...
class CompletedOrdersListView extends StatefulWidget {
  ...
  @override
  State<CompletedOrdersListView> createState() =>
      _CompletedOrdersListViewState();
}

class _CompletedOrdersListViewState extends State<CompletedOrdersListView> {
  @override
  void initState() {
    AppCubit.get(context).showProviderOrders(status: 'finish');
    super.initState();
  }
