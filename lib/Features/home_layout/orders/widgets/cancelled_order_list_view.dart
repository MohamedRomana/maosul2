...
class CancelledOrderListView extends StatefulWidget {
  const CancelledOrderListView({super.key});

  @override
  State<CancelledOrderListView> createState() => _CancelledOrderListViewState();
}

class _CancelledOrderListViewState extends State<CancelledOrderListView> {
  @override
  initState() {
    AppCubit.get(context).showOrders(status: 'refused ');
    super.initState();
  }
